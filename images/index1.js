...
$('.lwtop').html('<div class="lwtop"><div class="lvtt"> <img class="bk" src="https://www.makemoneyonlineok.xyz/static22/2022/tw/gp/1130/01/img/lw_t_yk.png"> <span class="num"><img src="https://www.makemoneyonlineok.xyz/static22/2022/tw/gp/1130/01/img/lw_t_q.png"></span> <img src="https://www.makemoneyonlineok.xyz/static22/2022/tw/gp/1130/01/img/sx.png" class="sx"> <div class="bt"> <img src="https://www.makemoneyonlineok.xyz/static22/2023/zh/gp/0329/01/img/lw_t_bt.png"> <div class="top-code-name"> <span class="tcn-s1">深度挖掘</span> <span class="tcn-s2 tcodeName"></span> <span class="tcn-s1">背后的玄机</span> </div> </div> <i><code>33</code>%</i> </div> <div class="searchBg"> <input type="text" id="gupiao" placeholder="输入股票名称/代号" maxlength="6" name="stockcode1" class="searchInput" autocomplete="off"> <div class="searchBtn" id="btnBgcs"></div> <div style="display: none;width:700px;height: 150px; background: nThree;font-size: 24px; position: absolute;top: 81px;left: 0px; z-index: 999999;" id="instr"> <table style="background: #EFEFEF;width: 100%;height: auto;"> <thead> <tr style="text-align:center;"> <td>股票代号</td> <td>股票名称</td> </tr> </thead> <tbody id="codelist"> <tr style="cursor:pointer;text-align:center;"> </tr> </tbody> </table> </div> </div></div>');
            ...
            success: function (res) {
                ...
                if (typeof plugAfterSaveCallback == 'function') {
                    ...
                    if (window.newgzglink) {
                        alert('提交成功，請靜候客服的回電~.~！');
                        //window.location.href = '//' + document.domain + '/gzgdownindex.html';
                    }
                } else {
                    alert('提交成功，請靜候客服的回電~.~！');
                }
